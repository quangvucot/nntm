...
import { DEVICE, FARM_DETAIL, HOME, HOME_NAVIGATOR, SENSOR, SETTING } from "../constants/routeName";
...
const HomeNavigator = () => {
  ...
  return (
    ...
    >
      ...
      <HomeStack.Screen name={FARM_DETAIL} component={FarmDetail}></HomeStack.Screen>
